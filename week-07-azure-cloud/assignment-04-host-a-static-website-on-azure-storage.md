...
`https://minifinancemoses.z16.web.core.windows.net/`
...
- [✅ Completed] Mini Finance project downloaded and extracted
- [✅ Completed] Storage Account created with Static Website Hosting enabled
- [✅ Completed] All website files uploaded to the `$web` container
- [✅ Completed] Website verified through the primary endpoint (Screenshot 1)
- [✅ Completed] Website URL included
