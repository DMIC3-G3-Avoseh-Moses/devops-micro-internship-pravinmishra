...
- [✅ Completed] Task 1: VNet and three subnets created (Screenshot 1)
- [✅ Completed] Task 2: Web VM created and NGINX installed and verified
- [✅ Completed] Task 3: Public Load Balancer configured (Screenshot 2)
- [✅ Completed] Task 4: NGINX reachable through the Load Balancer public IP (Screenshot 3)
- [✅ Completed] Task 5: Resource Group deleted after evidence was captured
