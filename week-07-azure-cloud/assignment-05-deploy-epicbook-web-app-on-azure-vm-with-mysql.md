...
- [✅ Completed] Task 1: Network foundation created with public/private subnets and NSGs (Screenshots 1–3)
- [✅ Completed] Task 2: VM provisioned and required software installed (Screenshots 4–5)
- [✅ Completed] Task 3: EpicBook frontend and backend deployed (Screenshots 6–8)
- [✅ Completed] Task 4: Private Azure Database for MySQL created and data imported (Screenshots 9–11)
- [✅ Completed] Task 5: End-to-end functionality validated (Screenshots 12–13, Public IP URL)
