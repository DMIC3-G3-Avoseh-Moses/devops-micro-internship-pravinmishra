...
- [✅ Completed] Task 1: Resource Group created (Screenshot 1)
- [✅ Completed] Task 2: Ubuntu VM provisioned with correct NSG rules (Screenshots 2 & 3)
- [✅ Completed] Task 3: SSH access verified (Screenshot 4)
- [✅ Completed] Task 4: Git, Node.js, and npm installed (Screenshot 5)
- [✅ Completed] Task 5: React app built successfully (Screenshot 6)
- [✅ Completed] Task 6: Nginx configured with SPA routing support (Screenshots 7 & 8)
- [✅ Completed] Task 7: App verified via the VM public IP, including route refresh (Screenshot 9)
- [✅ Completed] Task 8: SSH hardening applied (Screenshot 10, optional)
