...
![git status](A5T1S4.png)

---

#### Screenshot 5 — Output of `git commit`

![git commit](A5T1S5.png)
...
`https://github.com/pravinmishraaws/devops-micro-internship-interviews/pull/356`
...
`https://www.linkedin.com/posts/moses-avoseh_from-forking-repositories-to-opening-pull-share-7486138890509180928-JnTf/?utm_source=share&utm_medium=member_desktop&rcm=ACoAACZiz20BSL2chCMaU_0WK_2_7qktttgciMQ`

---

#### Screenshot — LinkedIn post showing your successfully created Pull Request

![LPPR](<Linkedln post showing successful creation of PR.png>)
