...
- [✅ Completed] Task 1: VPC, public/private subnets, IGW, and public routing created (Screenshots 1–3)
- [✅ Completed] Task 2: Least-privilege EC2 and RDS security groups created (Screenshots 4–5)
- [✅ Completed] Task 3: Ubuntu EC2 launched in the public subnet with SSH verified (Screenshots 6–7)
- [✅ Completed] Task 4: Node.js, npm, Nginx, and MySQL client installed (Screenshots 8–10)
- [✅ Completed] Task 5: Private MySQL RDS created with no public access (Screenshots 11–12)
- [✅ Completed] Task 6: Database initialized from the SQL dump (Screenshot 13)
- [✅ Completed] Task 7: Backend deployed and responding on port 3000 (Screenshots 14–16)
- [✅ Completed] Task 8: Nginx serving the frontend and reverse-proxying to the backend (Screenshots 17–18)
- [✅ Completed] Task 9: Frontend, backend, and RDS verified end to end (Screenshots 19–21)
