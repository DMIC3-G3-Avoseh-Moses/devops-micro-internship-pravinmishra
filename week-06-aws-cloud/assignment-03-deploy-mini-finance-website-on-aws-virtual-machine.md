...
- [✅ Completed] EC2 instance launched in a public subnet with SSH (22) and HTTP (80) allowed
- [✅ Completed] Connected to the instance via SSH
- [✅ Completed] Web server (Nginx or Apache) installed
- [✅ Completed] Mini Finance repository cloned and files copied to the web server root
