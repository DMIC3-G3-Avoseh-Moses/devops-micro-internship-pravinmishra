...
![](screenshots/W5A2T4S5.png)

---

#### Screenshot 6 — S4 showing all four Sub-tasks

![](screenshots/W5A2T4S6.png)
...
- [✅ Completed] Task 1: Private team-managed Scrum Space created with your name (Screenshot 1)
- [✅ Completed] Task 2: Epic "Polish DMI Website UI & Deploy" created (Screenshot 2)
- [✅ Completed] Task 3: All six Stories connected to the Epic, assigned to you, with descriptions/acceptance criteria/points/labels (Screenshots 3 & 4)
- [✅ Completed] Task 4: Four Sub-tasks created under both S2 and S4 (Screenshots 5 & 6)
- [✅ Completed] Task 5: Frontend and devops labels applied to all Stories (Screenshot 7)
- [✅ Completed] Task 6: One-week Sprint 1 started with the required Sprint Goal (Screenshots 8 & 9)
- [✅ Completed] Task 7: Frontend and devops filters demonstrated (Screenshots 10 & 11)
- [✅ Completed] Task 8: Burndown Chart opened for Sprint 1 (Screenshot 12)
