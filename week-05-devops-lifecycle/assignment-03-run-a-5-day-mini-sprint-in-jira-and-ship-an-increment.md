...
`https://www.loom.com/share/945a6225c84f4bc9b287176a10458d1f`
...
`https://www.linkedin.com/posts/moses-avoseh_sprint-completed-delivering-a-portfolio-share-7491551711694659584-srnM/?utm_source=share&utm_medium=member_desktop&rcm=ACoAACZiz20BSL2chCMaU_0WK_2_7qktttgciMQ`

---

#### LinkedIn Screenshot 1 — Published LinkedIn post showing the post content and at least one required link or proof image

![](screenshots/W5A3T6S18.png)
...
- [✅ Completed] Task 1: Sprint 1 started with the required Sprint Goal (Screenshots 1 & 2)
- [✅ Completed] Task 2: Day 1 footer implemented, committed, and deployed (Screenshots 3–6)
- [✅ Completed] Task 3: Day 2 deploy date made dynamic and documented (Screenshots 7–10)
- [✅ Completed] Task 4: Day 3 footer polished and validated on desktop and mobile (Screenshots 11–13)
- [✅ Completed] Task 5: Day 4 DMI Website call-to-action deployed and clickable (Screenshot 14)
- [✅ Completed] Task 6: Day 5 demo, retrospective, and Burndown evidence completed (Screenshots 15–17, video URL)
- [✅ Completed] Daily Scrum comments posted for Days 1–5
- [✅ Completed] LinkedIn post published with the GitHub URL, EC2 URL, required delivery details, and proof image
- [✅ Completed] LinkedIn Post URL and LinkedIn Screenshot 1 included
